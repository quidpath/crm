# settings/stage.py — Stage environment for CRM service
import logging
import os
...
_default_hosts = "stage.quidpath.com,www.stage.quidpath.com,stage-crm.quidpath.com,stage-api.quidpath.com,localhost,127.0.0.1,0.0.0.0"
ALLOWED_HOSTS = [h.strip() for h in os.environ.get("ALLOWED_HOSTS", _default_hosts).split(",") if h.strip()]
if "crm-backend-stage" not in ALLOWED_HOSTS:
    ALLOWED_HOSTS.append("crm-backend-stage")
